...
#Game Borders dont fly off screen
...
def yellow_movement(keys_pressed , yellow):
    if keys_pressed[pygame.K_a] and yellow.x - VEL > 0: # LEFT
        ...
        yellow.x += VEL
    elif keys_pressed[pygame.K_w] and yellow.y - VEL > 0: # top
        yellow.y -= VEL
    elif keys_pressed[pygame.K_s] and yellow.y + VEL + yellow.height  < HEIGHT - 15: # bottom
        yellow.y += VEL
...
def red_movement(keys_pressed , red):
    if keys_pressed[pygame.K_LEFT] and red.x - VEL > BORDER.x + BORDER.width: # LEFT
        ...
        red.x += VEL
    elif keys_pressed[pygame.K_UP] and red.y - VEL > 0: # top
        red.y -= VEL
    elif keys_pressed[pygame.K_DOWN] and red.y + VEL + red.height  < HEIGHT - 15: # bottom
        red.y += VEL


#handling bullets + moving bullets
...
def main():
    ...
    red_bullets = []
    yellow_bullets = []
    #makes sure to only loop 60 per second. 
...
# Only runs if you run this file alone not when it is imported.
